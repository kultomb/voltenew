...
def main():
    ...
    batch_props_cmd = (
        ...
        'setprop persist.mtk.volte.enable 3; '
        'setprop persist.radio.volte_state 3; '
        ...
        'setprop persist.vendor.mtk_ct_volte_support 3; '
        'setprop persist.vendor.mims_support 2; '
        'setprop persist.vendor.radio.mtk_dsbp_support 1; '
        'setprop persist.radio.volte_pro_sub0 1; '
        'setprop persist.radio.volte_pro_sub1 1; '
        'setprop persist.vendor.radio.volte_pro_sub0 1; '
