...
object ImsOverrideManager {
    ...
    fun getFixAllCommands(
        ...
        for (ns in listOf("global", "secure", "system")) {
            ...
            cmds.add("settings put $ns enhanced_4g_mode_enabled_sub0 $globalVal")
            cmds.add("settings put $ns enhanced_4g_mode_enabled_sub1 $globalVal")
            cmds.add("settings put $ns enhanced_4g_mode_enabled_sub2 $globalVal")
            ...
            cmds.add("settings put $ns volte_provisioned_sub0 $globalVal")
            cmds.add("settings put $ns volte_provisioned_sub1 $globalVal")
            cmds.add("settings put $ns editable_enhanced_4g_lte_bool 1")
            cmds.add("settings put $ns wfc_ims_enabled $vowifiVal")
            cmds.add("settings put $ns wfc_ims_enabled_sub0 $vowifiVal")
            cmds.add("settings put $ns wfc_ims_enabled_sub1 $vowifiVal")
            cmds.add("settings put $ns vt_ims_enabled $vtVal")
            cmds.add("settings put $ns vt_ims_enabled_sub0 $vtVal")
            cmds.add("settings put $ns vt_ims_enabled_sub1 $vtVal")
            cmds.add("settings put $ns volte_vt_enabled $globalVal")
            cmds.add("settings put $ns volte_vt_enabled_sub0 $globalVal")
            cmds.add("settings put $ns volte_vt_enabled_sub1 $globalVal")
            cmds.add("settings put $ns voice_call_type 1")
            cmds.add("settings put $ns voice_call_type_sub0 1")
            cmds.add("settings put $ns voice_call_type_sub1 1")
